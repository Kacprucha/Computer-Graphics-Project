...
def main ():
    ...
    while running:
        ...
        pygame.draw.circle(screen, BLACK, (400,200), 5, 5)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(0, -800, 0))
                ...
                if event.key == pygame.K_a:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(50, 0, 0))
                if event.key == pygame.K_d:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(-50, 0, 0))
                if event.key == pygame.K_w:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(0, 50, 0))
                if event.key == pygame.K_s:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(0, -50, 0))
                if event.key == pygame.K_UP:
                    for fig in figures:
                        fig.applay_geometric_transformation(get_translation_matrix(0, 0, -50))
